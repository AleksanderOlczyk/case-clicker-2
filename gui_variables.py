...
class GuiVariables:
    def __init__(self):
        ...
        self.activation_mode_var: bool = None
        self.cps_var: int = None
        self.cps_randomize_var: bool = None
        self.jitter_click_movement_var: bool = None
    ...
    def update_root(self, root):
        ...
        self.activation_mode_var = BooleanVar(value=constants.activation_mode, master=root)
